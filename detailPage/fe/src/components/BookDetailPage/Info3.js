...
import { Container, Tabs, Tab, Box, Typography, TextField, Button, Table, TableBody, TableCell, TableContainer, TableRow, Paper } from '@mui/material';
import './Info3.css';
    ...
    <Container sx={{ mt: 5 }}>
      ...
      <Box id="bookInfo" my={4} ref={bookInfoRef}>
        ...
        <Typography variant="body1">
          ...
          배송정보가 내용이 길지가 않아문제는 도서정보나 배송정보가 내용이 길지가 않아문제는 도서정보나 배송정보가 내용이 길지가 않아문제는 도서정보나
          배송정보가 내용이 길지가 않아문제는 도서정보나 배송정보가 내용이 길지가 않아문제는 도서정보나 배송정보가 내용이 길지가 않아문제는 도서정보나
          배송정보가 내용이 길지가 않아이 책은 타이틀에 대한 설명이 들어가는 곳입니다.
        </Typography>
      </Box>

      <Box id="author" my={4} ref={bookInfoRef}>
        <Typography variant="h4">저자의 다른 책들</Typography>
        <Typography variant="body1">{/* 저자의 다른 책들 북 카드를 여기에 넣습니다 */}이 곳에 저자의 다른 책들이 bookCard 형태로 들어옵니다.</Typography>
      </Box>
            ...
            <TableBody sx={{ outline: '1px solid #DFE4DF' }}>
              <TableRow sx={{ outline: '1px solid #DFE4DF' }}>
                ...
                <TableCell sx={{ outline: '1px solid #DFE4DF' }}>
                  <Box>
                    {' '}
                    - 마이페이지 <a href="/">반품/교환 신청 및 조회,</a> <a href="/">1:1 문의</a>, 고객만족센터(1544-3800), 중고샵(1566-4295)
                  </Box>
